...
if (!command || /^h(elp)?$/.test(command)) {
  console.log(`Usage: ${(0, _chalk.green)('nwb inferno')} ${(0, _chalk.yellow)('(run|build)')} ${(0, _chalk.cyan)('[options]')}
...
Commands:
  ${(0, _chalk.green)('nwb inferno run')} ${(0, _chalk.yellow)('<entry>')} ${(0, _chalk.cyan)('[options]')}
    ...
    Options:
      ...
      ${(0, _chalk.cyan)('--title')}        contents for <title> ${(0, _chalk.cyan)('[default: Inferno App]')}

  ${(0, _chalk.green)('nwb inferno build')} ${(0, _chalk.yellow)('<entry>')} ${(0, _chalk.cyan)('[dist_dir] [options]')}
...
if (!COMMAND_MODULES.hasOwnProperty(command)) {
  console.error(`${(0, _chalk.red)('Unknown inferno command:')} ${(0, _chalk.yellow)(command)}`);
  process.exit(1);
}
